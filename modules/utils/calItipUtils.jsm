     ...
     processFoundItems: function() {
         ...
         if (this.mFoundItems.length > 0) {
             ...
             if(this.mItipItem.targetCalendar == null)
             {
                 ...
                 console.log("targetCalendar set to mFoundItems[0].calendar");
                             ...
                             switch (method) {
                                 ...
                                 case "REQUEST": {
                                     ...
                                     if (!att) {
                                         ...
                                         let attendees = newItem.getAttendees({})
                                         for(let attTmp of attendees) 
                                         {
                                             /*console.log("ATTENDEE STATUS: "+attTmp.participationStatus);
                                             console.log("ATTENDEE MAIL: "+this.mItipItem.identity);
                                             console.log("ATTENDEE ID: "+attTmp.id);*/
 
                                             // id sous la forme mailto:mail@mail.fr
                                             if(attTmp.id.split(":")[1] == this.mItipItem.identity)
                                             {
                                                 console.log("Attendee determine par le destinataire.");
                                                 att = attTmp;
                                             }
                                         }
                                         if (!att) { 
                                             // fall back to using configured organizer
                                             console.log("Falling back to organizer !")
