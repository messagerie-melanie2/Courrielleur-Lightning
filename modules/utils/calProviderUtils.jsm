        ...
        isInvitation(aItem) {
            if (!this.mACLEntry || !this.mACLEntry.hasAccessControl) {
                ...
                if (id) {
                    ...
                    // CMel - MANTIS 0005010: Ne pas afficher la fenêtre summary si X-M2-ORG-MAIL corrrespond à une identité du calendrier
                    if (org.getProperty('X-M2-ORG-MAIL') && (org.getProperty('X-M2-ORG-MAIL').toLowerCase() == id.toLowerCase())) {
                        return false;
                    }
                    // Fin CMel
            ...
            for (let i = 0; i < ownerIdentities.length; i++) {
                ...
                // CMel - MANTIS 0005010: Ne pas afficher la fenêtre summary si X-M2-ORG-MAIL corrrespond à une identité du calendrier
                if (org.getProperty('X-M2-ORG-MAIL').toLowerCase() == identity) {
                	return false;
                }
