...
div.querySelector(".property-value").textContent=cal.attachments.makeAttachPrettyName(attachment);
fixeLigne(div);
itemContainer.appendChild(div);
first=false;
} else {
let prop=divprop.cloneNode("true");
prop.removeAttribute("id");
prop.querySelector(".property-value").textContent=cal.attachments.makeAttachPrettyName(attachment);
div.appendChild(prop);
}
}
}
