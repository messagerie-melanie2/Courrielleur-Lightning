...
calDavCalendar.prototype = {
    ...
    addItem: function(aItem, aListener) {
        ...
        var this_ = this;
        cal.attachments.readAttachmentsFiles(newItem, function () {
          return this_.doAdoptItem(newItem, aListener);
        });
        // CM2V6 - Bugzilla 168680 - Treatment of attachment of the event
    },
    ...
    adoptItem: function(aItem, aListener) {
        // CM2V6 - Bugzilla 168680 -  Treatment of attachment of the event
        var this_ = this;
        cal.attachments.readAttachmentsFiles(aItem, function () {
          return this_.doAdoptItem(aItem, aListener);
        });
        // Fn CM2V6 - Bugzilla 168680 -  Treatment of attachment of the event
    },
    ...
    */
    ...
    doModifyItem: function(aNewItem, aOldItem, aListener, aIgnoreEtag) {
        ...
        cal.attachments.readAttachmentsFiles(aNewItem, function () {
          ...
          let modifiedItemICS = this_.getSerializedItem(aNewItem);
          ...
          this_.sendHttpRequest(eventUri, modifiedItemICS, MIME_TEXT_CALENDAR, null, (channel) => {
              if (!aIgnoreEtag) {
                  channel.setRequestHeader("If-Match",
                                          this_.mItemInfoCache[aNewItem.id].etag,
                                          false);
              }
              return modListener;
          }, () => {
        ...
        // Fin CM2V6 - Bugzilla 168680 -  Treatment of attachment of the event
    },
            ...
            onStreamComplete: function(aLoader, aContext, aStatus, aResultLength, aResult) {
                ...
                if (responseStatus == 204 || responseStatus == 200 || responseStatus == 404) {
                    if (!aFromInbox) {
                        ...
                        // Fin CM2V6 - Bugzilla 168680 - Remove attachments related to the event
