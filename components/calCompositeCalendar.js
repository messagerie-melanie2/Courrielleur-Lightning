...
calCompositeCalendar.prototype = {
    ...
    addCalendar: function(aCalendar) {
        ...
        // CM2V7 - 0004845: Positionner l'agenda par défaut en premier lorsque la liste des agendas est demandés
        if (this.mDefaultCalendar && this.mDefaultCalendar.id == aCalendar.id) {
        	this.mCalendars.unshift(aCalendar);
        }
        else {
        	this.mCalendars.push(aCalendar);
        }
