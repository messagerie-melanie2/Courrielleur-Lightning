...
var gConfig = {
    ...
    // CMel
    attachFileCommand: null, // cmd_attach_file
    attachFileUriCommand: null, // cmd_attach_file_uri
    // Fin CMel
...
function updateItemTabState(aArg) {
    const lookup = {
        ...
        // CMel
        attachUrlCommand: updateUrlAttachment,
        attachFileCommand: updateFileAttachment,
        attachFileUriCommand: updateFileUriAttachment,
        // Fin CMel
...
// CMel
/**
 * Prompts the user to attach a file to this item.
 */
function attachFile() {
    sendMessage({ command: "attachFile" });
}
/**
 * Prompts the user to attach a file uri to this item.
 */
function attachFileURI() {
    sendMessage({ command: "attachFileURI" });
}
// Fin CMel

/**
 * Updates dialog controls related to item url attachments.
 *
 * @param {Object}  aArg                   Container
 * @param {boolean} aArg.attachUrlCommand  Enable the attach url command?
 */
// CMel
function updateUrlAttachment(aArg) {
// Fin CMel
...
// CMel
/**
 * Updates dialog controls related to item files attachments.
 *
 * @param {Object}  aArg                   Container
 * @param {boolean} aArg.attachUrlCommand  Enable the attach url command?
 */
function updateFileAttachment(aArg) {
    setElementValue("cmd_attach_file", !aArg.attachFileCommand && "true", "disabled");
}

/**
 * Updates dialog controls related to item files uri attachments.
 *
 * @param {Object}  aArg                   Container
 * @param {boolean} aArg.attachUrlCommand  Enable the attach url command?
 */
function updateFileUriAttachment(aArg) {
    setElementValue("cmd_attach_file_uri", !aArg.attachFileUriCommand && "true", "disabled");
}
// Fin CMel
