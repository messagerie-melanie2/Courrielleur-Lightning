...
function calPrint() {
  ...
  window.openDialog("chrome://calendar/content/calendar-print-dialog.xul", "Print", "chrome,dialog=no,all,centerscreen");
}

/**
 * Opens the print dialog
 */
function calItemPrint(aItem) {

  window.openDialog("chrome://calendar/content/calendar-print-item-dialog.xul", "Print", "chrome,dialog=no,all,centerscreen", {item: aItem});
}
